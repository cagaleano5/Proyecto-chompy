...
public class JDRegistrar_Proveedor extends javax.swing.JDialog {
    public JDRegistrar_Proveedor(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRO DE PROVEEDORES                                                                           S I O S");
        ...
        jcb_Tipo_Documento.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Seleccione", "C.C", "NIT", "C.E" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDRegistrar_Proveedor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDRegistrar_Proveedor dialog = new JDRegistrar_Proveedor(new javax.swing.JFrame(), true);
