 ...
 * @author Personal
 */
public class JDRegistrar_Factura extends javax.swing.JDialog {

    /**
     * Creates new form PRUEBA
     */
    public JDRegistrar_Factura(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("REGISTRO DE FACTURA                                                                                                                                    S I O S");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDRegistrar_Factura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDRegistrar_Factura dialog = new JDRegistrar_Factura(new javax.swing.JFrame(), true);
